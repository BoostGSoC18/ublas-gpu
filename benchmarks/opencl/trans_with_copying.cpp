...
class transposition_opencl_copying : public benchmark
{
public:
  transposition_opencl_copying() : benchmark("trans opencl with copying data") {}
...
int main(int, char **)
{
  ...
  benchmark::transposition_opencl_copying<float, ublas::basic_row_major<>> t1;
  t1.run(times);
